          ...
          <div className="p-8 space-y-8">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-1 opacity-50">
                ...
                <input type="text" disabled value={session.user.email} className="w-full bg-transparent border border-white/5 rounded-2xl px-5 py-4 text-xs text-white/60 cursor-not-allowed" />
              </div>
            </div>
            ...
            <div className="space-y-3 pt-2">
              ...
              <button onClick={handleLogout} className="w-full bg-white/5 text-rose-500 font-black py-4 rounded-2xl hover:bg-rose-500/10 active:scale-95 transition-all text-[9px] uppercase tracking-[0.2em] flex items-center justify-center gap-2">
